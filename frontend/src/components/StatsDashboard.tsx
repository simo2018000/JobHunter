...
export function StatsDashboard() {
  ...
  const handleTrigger = async () => {
    ...
    try {
      ...
      setTimeout(fetchStats, 5000); // Refresh stats a bit later
    } catch (error) {
  ...
  return (
    <div className="flex flex-col gap-4 mb-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight text-primary">CyberSec Jobs</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="col-span-1">
          ...
          <CardContent className="pl-2 h-[200px]">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={stats.jobsBySource} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={60} fill="#8884d8">
        ...
        <Card className="col-span-1">
          <CardHeader>
            <CardTitle>Jobs Scraped / Day</CardTitle>
          </CardHeader>
